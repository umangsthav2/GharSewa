        ...
        child: Column(
          children: [
            CarouselSlider(
              ...
              items: [
                Image.asset(fit: BoxFit.cover, 'lib/assets/images/OliBaa.jpg'),
                Image.asset(fit: BoxFit.cover, 'lib/assets/images/Madhav.jpg'),
                Image.asset(
                  fit: BoxFit.cover,
                  'lib/assets/images/Prachanda.jpg',
                ),
                Image.asset(fit: BoxFit.cover, 'lib/assets/images/Rabi.jpg'),
              ],
            ),
            InkWell(
              child: GSListTile(
